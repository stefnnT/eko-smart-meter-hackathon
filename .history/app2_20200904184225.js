...
const todayHistory = document.querySelector('#unit-price');
const weekHistory = document.querySelector('#unit-price');
const monthHistory = document.querySelector('#unit-price');
