                          ...
                          <div class="more-details">
                            ...
                            <div class="details">
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].meterDetails.tarriffUnitPrice}</div>
                                </div>
                                <div>
                            ...
                            <div class="details">
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.voltage}</div>
                                </div>
                                <div>
                                    <div class="detail-label">Frequency:</div>
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.frequency}</div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.potentialLoss | toUppercase()}</div>
                                </div>
                            </div>
                            <div class="details">
                                <div>
