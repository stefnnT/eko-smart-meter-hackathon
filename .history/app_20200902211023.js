                        ...
                        <thead>
                            <tr>
                                ...
                                <td class="text-center" style="width:10%">
                                  <span class="label ${details[0].meterDetails.lastDeviceStatus.mainsIn ==='on'?'label-success':'label-warning' }">Normal</span></td>
                                <td class="text-center" style="width:10%"><span class="label ${details[0].meterDetails.lastDeviceStatus.mainsIn ==='on'?'label-success':'label-warning' }">Normal</span></td>
