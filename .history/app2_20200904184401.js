...
const init = _ => {
  ...
  xhr.onload = function() {
    if (xhr.status == 200) { 
      ...
      todayHistory.textContent = result.meterUsageHistory.tarriffUnitPrice;
      weekHistory.textContent = result.meterUsageHistory.tarriffUnitPrice;
      monthHistory.textContent = result.meterUsageHistory.tarriffUnitPrice;
