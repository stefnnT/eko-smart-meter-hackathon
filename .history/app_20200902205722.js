const child = (details, index) => `<div class="row navbar-default" style="margin-bottom: 10px;">
            <div class="col-md-12">
                    <table class="table" style="margin-bottom: 0;">
                        <thead>
                            <tr>
                                ...
                                <td class="text-center" style="width:12.5%">${details[0].meterDetails.lastDeviceStatus}</td>
                                <td class="text-center" style="width:12.5%">${details[0].meterDetails.lastDeviceStatus.unitLe}</td>
