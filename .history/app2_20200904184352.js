...
const init = _ => {
  ...
  xhr.onload = function() {
    if (xhr.status == 200) { 
      ...
      todayHistory.textContent = result.meterDetails.tarriffUnitPrice;
      weekHistory.textContent = result.meterDetails.tarriffUnitPrice;
      monthHistory.textContent = result.meterUsageHis.tarriffUnitPrice;
