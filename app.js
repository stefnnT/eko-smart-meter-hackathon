...
const child = (details, index) => `<div class="row navbar-default form-row">
            <div class="col-md-12">
                    <table class="table" style="margin-bottom: 0;">
                        <thead>
                            <tr>
                                <td class="text-center" style="width:5%; border-left: 1px solid white;">${index}</td>
                    ...
                    <div id="collapse${index}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" style="border-top: 1px solid white;">
                          ...
                          <div class="more-details">
                            <div class="details">
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].subscriberBiodata.firstName+' '+details[0].subscriberBiodata.lastName}</div>
                                </div>
                                <div>
                                    <div class="detail-label">Address:</div>
                                    <div class="detail">${details[0].subscriberBiodata.address}</div>
                                </div>
                                <div>
                                    <div class="detail-label">Phone:</div>
                                    <div class="detail">${details[0].subscriberBiodata.phone}</div>
                                </div>
                            </div>
                            <div class="details">
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].meterDetails.meterNumber}</div>
                                </div>
                                <div>
                                    <div class="detail-label">Tarriff:</div>
                                    <div class="detail">${details[0].meterDetails.tarriffCode}</div>
                                </div>
                                <div>
                                    <div class="detail-label">Unit cost:</div>
                                    <div class="detail">NGN ${details[0].meterDetails.tarriffUnitPrice}</div>
                                </div>
                                <div>
                                    <div class="detail-label">Last recharge:</div>
                                    <div class="detail">02-08-2020</div>
                                </div>
                            </div>
                            <div class="details">
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.voltage} V</div>
                                </div>
                                <div>
                                    <div class="detail-label">Frequency:</div>
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.frequency} Hz</div>
                                </div>
                                <div>
                                    <div class="detail-label">Temprature:</div>
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.temperature} &#8451;</div>
                                </div>
                                <div>
                                    <div class="detail-label">Potential loss:</div>
                                    <div class="detail">${details[0].meterDetails.lastDeviceStatus.potentialLoss}</div>
                                </div>
                            </div>
                            <div class="details">
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="detail">${details[0].meterUsageHistory.today} kWH</div>
                                </div>
                                <div>
                                    <div class="detail-label">Last 7 days:</div>
                                    <div class="detail">${details[0].meterUsageHistory.week} kWH</div>
                                </div>
                                <div>
                                    <div class="detail-label">Last 30 days:</div>
                                    <div class="detail">${details[0].meterUsageHistory.month} kWH</div>
                                </div>
                            </div>
                        </div>
                      </div>
...
const init = _ => {
  ...
  xhr.open('GET', `${baseUrl}routes/disco/get_customers/`);
...
const addSubscriber = _ => {
  window.location.replace("file:///C:/Users/HP/Desktop/LPS/add.html");
}